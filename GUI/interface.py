...
"}\n"
"#frame_6, #frame_8, #popupNotificationSubContainer, #GrpHeaderSubContainer, #FriendsFrame1{\n"
"    background-color: #16191d;\n"
"    border-radius: 10px;\n"
"}\n"
"\n"
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 465, 469))
...
"}")
        ...
        self.FriendsFrame1 = QtWidgets.QFrame(self.widget_5)
        ...
        self.horizontalLayout_59 = QtWidgets.QHBoxLayout(self.FriendsFrame1)
        self.horizontalLayout_59.setObjectName("horizontalLayout_59")
        self.frame_67 = QtWidgets.QFrame(self.FriendsFrame1)
        ...
        self.label_8 = QtWidgets.QLabel(self.frame_67)
        font = QtGui.QFont()
        font.setFamily("Swis721 Blk BT")
        font.setPointSize(22)
        self.label_8.setFont(font)
        self.label_8.setObjectName("label_8")
        self.verticalLayout_88.addWidget(self.label_8)
        ...
        self.verticalLayout_88.addWidget(self.label_38)
        self.horizontalLayout_59.addWidget(self.frame_67)
        self.frame_68 = QtWidgets.QFrame(self.FriendsFrame1)
        ...
        self.AddFriends = QtWidgets.QPushButton(self.frame_68)
        self.AddFriends.setText("")
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icons2/icons2/user-plus.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.AddFriends.setIcon(icon17)
        self.AddFriends.setIconSize(QtCore.QSize(24, 24))
        self.AddFriends.setObjectName("AddFriends")
        self.horizontalLayout_60.addWidget(self.AddFriends)
        self.horizontalLayout_59.addWidget(self.frame_68, 0, QtCore.Qt.AlignRight)
        self.gridLayout_7.addWidget(self.FriendsFrame1, 0, 0, 1, 1, QtCore.Qt.AlignTop)
        ...
        self.verticalLayout_87.addWidget(self.frame_64)
        ...
        self.frame_62 = QtWidgets.QFrame(self.FriendsPage)
        ...
        self.verticalLayout_84.addWidget(self.frame_62)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icons2/icons2/bar-chart-2.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.ExpenseGraphBtn.setIcon(icon18)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icons2/icons2/trending-up.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.DebtGraphBtn.setIcon(icon19)
        ...
        self.horizontalLayout_28.addWidget(self.pushButton_2, 0, QtCore.Qt.AlignRight)
        ...
        self.verticalLayout_82.addWidget(self.label_36, 0, QtCore.Qt.AlignTop)
        ...
        self.scrollAreaWidgetContents_18.setGeometry(QtCore.QRect(0, 0, 422, 496))
        ...
        self.groupBox_12 = QtWidgets.QGroupBox(self.scrollAreaWidgetContents_18)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout_83 = QtWidgets.QVBoxLayout(self.groupBox_12)
        self.verticalLayout_83.setObjectName("verticalLayout_83")
        self.GrpNameLabel_3 = QtWidgets.QLabel(self.groupBox_12)
        font = QtGui.QFont()
        font.setFamily("Swis721 Blk BT")
        font.setPointSize(10)
        self.GrpNameLabel_3.setFont(font)
        self.GrpNameLabel_3.setObjectName("GrpNameLabel_3")
        self.verticalLayout_83.addWidget(self.GrpNameLabel_3)
        self.GrpNameInput_4 = QtWidgets.QLineEdit(self.groupBox_12)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.GrpNameInput_4.sizePolicy().hasHeightForWidth())
        self.GrpNameInput_4.setSizePolicy(sizePolicy)
        self.GrpNameInput_4.setMinimumSize(QtCore.QSize(0, 37))
        self.GrpNameInput_4.setMaximumSize(QtCore.QSize(16777215, 59))
        self.GrpNameInput_4.setObjectName("GrpNameInput_4")
        self.verticalLayout_83.addWidget(self.GrpNameInput_4)
        self.NoMembersLabel_3 = QtWidgets.QLabel(self.groupBox_12)
        font = QtGui.QFont()
        font.setFamily("Swis721 Blk BT")
        font.setPointSize(10)
        self.NoMembersLabel_3.setFont(font)
        self.NoMembersLabel_3.setObjectName("NoMembersLabel_3")
        self.verticalLayout_83.addWidget(self.NoMembersLabel_3)
        self.scrollArea_18 = QtWidgets.QScrollArea(self.groupBox_12)
        ...
        self.scrollAreaWidgetContents_19.setGeometry(QtCore.QRect(0, 0, 386, 305))
        ...
        self.verticalLayout_83.addWidget(self.scrollArea_18)
        ...
        self.frame_61 = QtWidgets.QFrame(self.widget_4)
        ...
        self.horizontalLayout_57.addWidget(self.frame_61)
        self.verticalLayout_83.addWidget(self.widget_4)
        self.FinalAddGrpBtn_3 = QtWidgets.QPushButton(self.groupBox_12)
        font = QtGui.QFont()
        font.setFamily("Swis721 Blk BT")
        font.setPointSize(10)
        self.FinalAddGrpBtn_3.setFont(font)
        self.FinalAddGrpBtn_3.setIcon(icon17)
        self.FinalAddGrpBtn_3.setIconSize(QtCore.QSize(20, 20))
        self.FinalAddGrpBtn_3.setObjectName("FinalAddGrpBtn_3")
        self.verticalLayout_83.addWidget(self.FinalAddGrpBtn_3)
        self.horizontalLayout_56.addWidget(self.groupBox_12)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/icons2/icons2/plus-square.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.FinalAddGrpBtn.setIcon(icon20)
        ...
        self.FinalAddGrpBtn_2.setIcon(icon20)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/icons2/icons2/x-octagon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.ClosePopUpBtn.setIcon(icon21)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_8.setText(_translate("MainWindow", "Friends"))
        self.label_38.setText(_translate("MainWindow", "Net Balance:"))
        self.AddFriends.setToolTip(_translate("MainWindow", "Add Friends"))
        ...
        self.label_36.setText(_translate("MainWindow", "Original Graph"))
        ...
        self.GrpNameLabel_3.setText(_translate("MainWindow", "New Member\'s Name"))
        self.NoMembersLabel_3.setText(_translate("MainWindow", "Which expenses she/he was in?"))
        ...
        self.FinalAddGrpBtn_3.setText(_translate("MainWindow", "Add New Member"))
